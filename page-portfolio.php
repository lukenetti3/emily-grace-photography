  ...
  <div class="container">
    ...
    <div class="container img-set-3">
        ...
        <div class="col-12 col-lg-4 px-2 overlay-div-portfolio">
          <img class="img-fluid w-100 h-100" src="<?php echo $topRow1 ?>">
            <div class="overlay-portfolio d-flex align-items-center justify-content-center">
              <a href="<?php echo get_bloginfo('wpurl') ?>/portfolio-wedding"><p class="overlay-Ptxt text-center">See More</p></a>
            </div>
        </div>
        <div class="col-12 col-lg-4 px-2 overlay-div-portfolio">
          <img class="img-fluid w-100 h-100 myWorkImg" src="<?php echo $topRow2 ?>">
          <div class="overlay-portfolio d-flex align-items-center justify-content-center">
            <a href="<?php echo get_bloginfo('wpurl') ?>/portfolio-engagement"><p class="overlay-Ptxt text-center">See More</p></a>
          </div>
        </div>
        <div class="col-12 col-lg-4 px-2 overlay-div-portfolio">
      ...
      <div class="row py-4 no-gutters">
        <div class="col-12 col-lg-4 px-2 overlay-div-portfolio">
          <img class="img-fluid w-100 h-100" src="<?php echo $bottomRow1 ?>">
          <div class="overlay-portfolio d-flex align-items-center justify-content-center">
            <a href="<?php echo get_bloginfo('wpurl') ?>/information"><p class="overlay-Ptxt text-center">See More</p></a>
          </div>
        </div>
        <div class="col-12 col-lg-4 px-2 overlay-div-portfolio">
          <img class="img-fluid w-100 h-100 myWorkImg" src="<?php echo $bottomRow2 ?>">
          <div class="overlay-portfolio d-flex align-items-center justify-content-center">
            <a href="<?php echo get_bloginfo('wpurl') ?>/information"><p class="overlay-Ptxt">See More</p></a>
          </div>
        </div>
        <div class="col-12 col-lg-4 px-2 overlay-div-portfolio">
          <img class="img-fluid w-100 h-100 myWorkImg" src="<?php echo $bottomRow3 ?>">
          <div class="overlay-portfolio d-flex align-items-center justify-content-center">
            <a href="<?php echo get_bloginfo('wpurl') ?>/information"><p class="overlay-Ptxt text-center">See More</p></a>
          </div>
        </div>
